...
dental.forEach((paciente) => {
  document.write(`<p>Hora: ${paciente.hora} - Especialista: ${paciente.especialista} - Paciente: ${paciente.paciente} - RUT: ${paciente.rut} - Previsión: ${paciente.prevision}</p>` )
})

let totalPacientes = radiologia.concat(traumatologia, dental);
document.write(totalPacientes);
...
let totalIsapres = dental.filter(function(paciente){
...
let totalFonasa = totalPacientes.filter(function(paciente){
